...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [LAYER_5] = { ENCODER_CCW_CW(C(KC_PMNS),C(KC_PPLS)},
    [LAYER_6] = { ENCODER_CCW_CW(C(KC_PMNS),C(KC_PPLS)},
    [LAYER_7] = { ENCODER_CCW_CW(C(KC_PMNS),C(KC_PPLS)},
    [LAYER_8] = { ENCODER_CCW_CW(C(KC_PMNS),C(KC_PPLS)},
    [LAYER_9] = { ENCODER_CCW_CW(C(KC_PMNS),C(KC_PPLS)},
    [LAYER_10] = { ENCODER_CCW_CW(C(KC_PMNS),C(KC_PPLS)}                              
};
